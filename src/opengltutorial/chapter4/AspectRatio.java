...
public class AspectRatio extends TutorialProgram {
	...
	public void display(long deltaTime) {
		...
		glUniform2f(offsetLocation, 1.5f, 0.5f);
	...
	public void resize() {
		perspectiveMatrix[0] = frustumScale / (Display.getWidth() / (float)Display.getHeight());
		perspectiveMatrix[5] = frustumScale;
		perspectiveMatrixBuffer.put(perspectiveMatrix);
		perspectiveMatrixBuffer.flip();
