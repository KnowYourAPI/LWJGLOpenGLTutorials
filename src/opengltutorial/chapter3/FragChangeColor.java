...
public class FragChangeColor extends TutorialProgram {
	
	private int positionBufferObject;
	private int program;
	private int elapsedTimeUniform;
	private int loopDuration;
	private int fragLoopDuration;
	...
	public FragChangeColor() {
		...
		try {
			...
			Display.setTitle("Fragment Shader Change Color");
	...
	private int initializeProgram() {
		...
		int fragmentShader = loadShader("shaders/CalcColor.frag"); 
		...
		int fragLoopDurationUniform = glGetUniformLocation(program, "fragLoopDuration");
		
		glUseProgram(program);
		glUniform1f(loopDurationUniform, loopDuration);
		glUniform1f(fragLoopDurationUniform, fragLoopDuration);
		glUseProgram(0);
	...
	public static void main(String[] args) {
		FragChangeColor fragChangeColor = new FragChangeColor();
		fragChangeColor.execute();
	}
